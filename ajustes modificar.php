            ...
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="nombre" id="nombre" class="form-control" value="<?php echo $nombre?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="apellido1" id="apellido1" class="form-control" value="<?php echo $apellido1?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="apellido2" id="apellido2" class="form-control" value="<?php echo $apellido2?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="uet" id="uet" class="form-control" value="<?php echo $uet?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="ju" id="ju" class="form-control" value="<?php echo $ju?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="usuario" id="usuario" class="form-control" value="<?php echo $usuario?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <input type="text" form="form_datos" name="password" id="password" class="form-control" value="<?php echo $password?>" oninput="btn_guardar_rojo()" required>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around ">
                <div class="col-auto d-flex align-items-center mt-1 mb-1 mr-1 pt-1 pb-1 pr-1 justify-content-center text-center">
                    <div class="input-group border border-dark rounded">
                        ...
                        <select form="form_datos" class="form-control" type="text" name="tipo" id="tipo"  value="<?php echo $tipo;?>" onchange="btn_guardar_rojo()" required>
                            <?php 
                                $default = "$tipo";
                                $states = array(
                                            ""=>"",
...
<script>
    ...
    function guardar_datos()
    {
        ...
        $.ajax({
            url: 'funciones_ajustes/guardar_ajuste_modificar_usuario.php?id='+id,
            type: 'POST',
            dataType: "json",
            data: form,
            cache: false,
