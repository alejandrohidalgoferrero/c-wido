...
<body style="background-color: #D8F5CA" class="text-muted">
    ...
    <h1 align="center">HxH inyectoras</h1>
...
<form action="HxH INY cargar fecha.php" method="POST"> 
    ...
    <div class="col-md-6 offset-md-3 mt-5 border rounded" style="background-color:#ECECEC">
        <div class="row  align-items-center mr-auto ml-auto mt-1 mb-3 pt-2 pb-2 pl-2 pr-2" style="width: 88%" >            
            ...
            <label><strong>Seleccionar inyectora:</strong></label>
            <select class="mdb-select md-form" type="text" name="inyectora" id="inyectora"required>
                <?php 
                $default = "";
                $states = array(""=>"", "Inyectora 1"=>"Inyectora 1", "Inyectora 2"=>"Inyectora 2","Inyectora 3"=>"Inyectora 3", "Inyectora 4"=>"Inyectora 4", "Inyectora 5"=>"Inyectora 5","Inyectora 6"=>"Inyectora 6", "Inyectora 7"=>"Inyectora 7");
