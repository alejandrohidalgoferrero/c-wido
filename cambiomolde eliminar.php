...
<form action="cambiomolde eliminar support.php" method="POST"> 
    ...
    <div class="row mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 justify-content-center ">
        <div class="col-5 pt-2 pb-2 pl-2 pr-2 justify-content-center text-center text-dark" style= "border:muted 3px solid">
            <label align="center" class="ml-1 mr-1 pl-1 pr-1" for="inyectora"> ¿Está seguro de que desea eliminar este proceso de cambio de molde? </label>     
