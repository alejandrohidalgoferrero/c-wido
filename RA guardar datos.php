...
for ($i = 62; $i <= 64; $i++) {
    ...
    $sql1="UPDATE `ra_registro` SET `nombre` = '$nombre', `dato1` = '$dato1',`dato2` = '$dato2',`dato3` = '$dato3' WHERE `ra_registro`.`id` =$i AND `ra_registro`.`num_ra`='$num_ra' ";
    $consulta1 = mysqli_query($conexion, $sql1);
}
header ('Location: RA valorar datos.php');
