    ...
    <div class="row mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 justify-content-center ">
        ...
        <div class="col-5 pt-2 pb-2 pl-2 pr-2 justify-content-center text-center text-dark border rounded" style= "background-color:#E0F4F2;">
            <label align="center" class="ml-1 mr-1 pl-1 pr-1" for="">
                <strong>Actividad / Area / Maquina: </strong><input type="text" name="data_1" required id="data_1" value="<?php echo $actividad;?>"> 
                    ...
                    ?>
                        <div class="col ml-1 mr-1" >
                            <label class="ml-1 mr-1 pl-1 pr-1 text-left"  for="molde">
                                ...
                                <input type="text" name="data_9" id="data_9"  value="<?php echo $actividad?>">  
                ...
                ?>
                    <div class="col ml-1 mr-1" >
                        <label class="ml-1 mr-1 pl-1 pr-1 text-left"  for="molde">
                            ...
                            <input type="date" name="data_24" id="data_24" value="<?php echo $actividad?>"> 
                        </label>
                    </div>
                </div>
...
<table style="text-align: center;" align="center" border="1"class="table table-striped table-sm ">
    ...
    <?php 
        ...
        <tr style="background-color:'.$color.'">
            ...
            <td class="" style="font-size: medium;">
            <select class="border rounded"  type="text" name="data3_'.$contador.'" id="selectA'.$contador.'">';?>
                <?php
                $default = $row['dato3'];
                $states = array(
                            ""=>"",
...
<div class="row mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 justify-content-center">         
    ...
    <?php 
        ...
        <tr>
            ...
            <td class="" style="font-size: medium;">
                <input type="text" style="width: 100%;" placeholder="FR:" name="data_'.$contador.'" id="data_'.$contador.'"  value="'.$row['dato1'].'">            
            </td>
            <td class="" style="font-size: medium;">
                <input type="text" style="width: 100%;" placeholder="MC:" name="data2_'.$contador.'" id="data2_'.$contador.'"  value="'.$row['dato2'].'">            
            </td>
            <td class="" style="font-size: medium;">
                <input type="text" style="width: 100%;" name="data3_'.$contador.'" id="data3_'.$contador.'"  value="'.$row['dato3'].'">            
            </td>
...
<?php 
    ...
    <tr>
        ...
        <td class="" style="font-size: medium;">
            <input type="text" style="width: 100%;"  name="data_'.$contador.'" id="data_'.$contador.'"  value="'.$row['dato1'].'">            
        </td>
        <td class="" style="width: 25%; font-size: medium;">
            <input type="text" style="width: 100%;" name="data2_'.$contador.'" id="data2_'.$contador.'"  value="'.$row['dato2'].'">            
        </td>
    </tr>';
...
<table style="text-align: center;" align="center" border="1"class="table table-striped table-sm ">
    ...
    <?php 
        ...
        <tr>
            ...
            <td class="" style="font-size: medium;">
                <input type="text" style="width: 100%;" placeholder="firma" name="data_'.$contador.'" id="data_'.$contador.'"  value="'.$row['dato1'].'">            
            </td>
...
<table style="text-align: center;" align="center" border="1"class="table table-striped table-sm ">
    <thead class="thead-dark">
      <tr>
        ...
        <?php           
        $sql = "SELECT * FROM `ra_registro` WHERE `ra_registro`.`num_ra` = '$num_ra' AND `ra_registro`.`id` =106";
        $consulta = mysqli_query($conexion, $sql);

        while ($row = mysqli_fetch_array($consulta)) {
            $notaelevada=$row['dato1'];
        }
        $sql = "SELECT * FROM `ra_registro` WHERE `ra_registro`.`num_ra` = '$num_ra' AND `ra_registro`.`id` =107";
        $consulta = mysqli_query($conexion, $sql);

        while ($row = mysqli_fetch_array($consulta)) {
            $notasuma=$row['dato1'];
        }
        $sql = "SELECT * FROM `ra_registro` WHERE `ra_registro`.`num_ra` = '$num_ra' AND `ra_registro`.`id` =105";
        $consulta = mysqli_query($conexion, $sql);

        while ($row = mysqli_fetch_array($consulta)) {
            $fechaproxima=$row['dato1'];
        }
        ?>
    ...
    <tbody>
      <tr>
        <td>
            <input type="text" style="width: 100%;"  name="data_106" id="data_106"  value="<?php echo $notaelevada?>">            
        </td>
        <td>
            <input type="text" style="width: 100%;"  name="data_107" id="data_107"  value="<?php echo $notasuma?>">            
        </td>
        <td>
            <input type="date" name="data_105" id="data_105"  value="<?php echo $fechaproxima?>"> 
        </td>
      </tr>
    </tbody>
  </table>
