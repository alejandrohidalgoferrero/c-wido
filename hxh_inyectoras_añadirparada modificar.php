...
<?php
    ...
    $sql = "SELECT * FROM `$tabla_problemas` WHERE  `id`='$id'";
    $consulta = mysqli_query($conexion, $sql); 
...
<h1 align="center">MODIFICAR PARADA.</h1>
...
<form action="hxh_inyectoras_añadirparada modificar support.php" method="POST"> 
            ...
            <label align="center" class="ml-1 mr-1 pl-1 pr-1" for="inyectora">
                ...
                <div class="row mt-1 mb-1 ml-1 mr-1 text-left text-dark" >
                    <div class="col ml-1 mr-1" >
                        ...
                        <input type="text" name="tiempo" id="tiempo"  value="<?php echo $tiempo;?>"> 
                    </div>
                </div>
                <div class="row mt-1 mb-1 ml-1 mr-1 text-left text-dark" >
                    <div class="col ml-1 mr-1" >
                        ...
                        <textarea class="align-middle" id="sintoma" name="sintoma" rows="1" cols="60" ><?php echo $sintoma;?></textarea>
                    </div>
                </div>
                <div class="row mt-1 mb-1 ml-1 mr-1 text-left text-dark" >
                    <div class="col ml-1 mr-1" >
                        ...
                        <textarea class="align-middle" id="causa" name="causa" rows="1" cols="60" ><?php echo $causa;?></textarea>                  
                    </div>
                </div>
                <div class="row mt-1 mb-1 ml-1 mr-1 text-left text-dark" >
                    <div class="col ml-1 mr-1" >
                        ...
                        <textarea class="align-middle"id="resultado" name="resultado" rows="1" cols="60"><?php echo $resultado;?></textarea>                        
                    </div>
                </div>
                <div class="row mt-1 mb-1 ml-1 mr-1 text-left text-dark" >
                    <div class="col ml-1 mr-1" >
