...
$sql ="INSERT INTO `$tabla_problemas`(`inyectora`, `fecha`, `turno`, `numero`, `operario`, `hora`, `hour`, `sintoma`, `causa`, `resultado`, `tipo`, `tiempo`) VALUES ('$iny','$fecha','$turno','$parada','$nombre','$hora','$hour','$sintoma','$causa','$resultado','$tipo','$tiempo')";
