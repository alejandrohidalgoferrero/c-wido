...
<body class="bg-warning text-muted">
  ...
  <?php
    ...
    $ip="LOCALHOST";
    session_start();
    if(isset($_POST['num_check']))
    {
    $num_check=$_POST['num_check'];
    $_SESSION['num_check']=$num_check;
    }
    else
    {
    $num_check=$_SESSION['num_check'];
    }
    include('nav.php');
    
    $consulta = "SELECT * FROM app_elementos_elevacion_ra_registro WHERE `num_ra`='$num_check' AND  `id`='1'";
...
<h1 align="center">RISK ASSESMENT. VALORAR DATOS.</h1>
...
<div class="row mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 justify-content-center ">
  <form action="app_elementos_elevacion_verficacion_ra_guardar_registro.php" method="POST"> 
                     
 </div>
    <div class="row mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 justify-content-center ">
        <?php 
            $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` =1";
            $consulta = mysqli_query($conexion, $sql);
        ...
        <div align="center" class="col-12 pt-2 pb-2 pl-2 pr-2 " style= "border:muted 3px solid">               
            <div class="row mt-1 mb-1 ml-10 mr-10 pt-1 pb-1 pl-10 pr-10 justify-content-center">
                <div align="center"class="col mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                    ...
                    <?php 
                    $contador=2;
                    $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 1 AND `app_elementos_elevacion_ra_registro`.`id` < 9";
                    $consulta = mysqli_query($conexion, $sql);
                    ...
                    <?php 
                    $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` =9";
                    $consulta = mysqli_query($conexion, $sql);
                ...
                <div align="center"class="col mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                    ...
                    <?php 
                    $contador=10;
                    $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 9 AND `app_elementos_elevacion_ra_registro`.`id` < 18";
                    $consulta = mysqli_query($conexion, $sql);
                ...
                <div align="center"class="col mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                    ...
                    <?php 
                    $contador=18;
                    $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 17 AND `app_elementos_elevacion_ra_registro`.`id` < 24";
                    $consulta = mysqli_query($conexion, $sql);
            ...
            <div align="center"class="col mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                ...
                <?php 
                $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` =24";
                $consulta = mysqli_query($conexion, $sql);
                ...
                <?php 
                $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` =25";
                $consulta = mysqli_query($conexion, $sql);
...
<table style="text-align: center;" align="center" border="1"class="table table-striped table-sm ">
    ...
    <?php 
            $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 25 AND `app_elementos_elevacion_ra_registro`.`id` < 62 AND `app_elementos_elevacion_ra_registro`.`dato1` = 'SI' ";
            $consulta = mysqli_query($conexion, $sql);
            $contador =26; 
            while ($row = mysqli_fetch_array($consulta)) {
            $producto=0;
...
<?php 
            $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 61 AND `app_elementos_elevacion_ra_registro`.`id` < 65 AND `app_elementos_elevacion_ra_registro`.`dato1` = 'SI' ";
            $consulta = mysqli_query($conexion, $sql);
            $contador =62; 
            while ($row = mysqli_fetch_array($consulta)) {
                $producto=0;
...
<?php 
            $sumatotal=0;
            $maximo=0;
            $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 25 AND `app_elementos_elevacion_ra_registro`.`id` < 65 AND `app_elementos_elevacion_ra_registro`.`dato1` = 'SI' ";
            $consulta = mysqli_query($conexion, $sql);
            while ($row = mysqli_fetch_array($consulta)) {
...
<div class="row mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 justify-content-center">         
        <div align="center" class="col-12 pt-2 pb-2 pl-2 pr-2 " style= "border:muted 3px solid">               
            <div class="row mt-1 mb-1 ml-10 mr-10 pt-1 pb-1 pl-10 pr-10 justify-content-center">
                <div align="center"class="col mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                    ...
                    <?php 
                    $contador=66;
                    $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 65 AND `app_elementos_elevacion_ra_registro`.`id` < 81";
                    $consulta = mysqli_query($conexion, $sql);
                ...
                <div align="center"class="col mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                    ...
                    <?php 
                    $contador=82;
                    $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 81 AND `app_elementos_elevacion_ra_registro`.`id` < 88";
                    $consulta = mysqli_query($conexion, $sql);
    ...
    <?php 
            $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 87 AND `app_elementos_elevacion_ra_registro`.`id` < 98 ";
            $consulta = mysqli_query($conexion, $sql);
            $contador =88; 
            while ($row = mysqli_fetch_array($consulta)) {
...
<?php 
        $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 97 AND `app_elementos_elevacion_ra_registro`.`id` < 102 ";
        $consulta = mysqli_query($conexion, $sql);
        $contador =98; 
        while ($row = mysqli_fetch_array($consulta)) {
...
<table style="text-align: center;" align="center" border="1"class="table table-striped table-sm ">
    ...
    <?php 
            $sql = "SELECT * FROM `app_elementos_elevacion_ra_registro` WHERE `app_elementos_elevacion_ra_registro`.`num_ra` = '$num_check' AND `app_elementos_elevacion_ra_registro`.`id` > 101 AND `app_elementos_elevacion_ra_registro`.`id` < 105 ";
            $consulta = mysqli_query($conexion, $sql);
            $contador =102; 
            while ($row = mysqli_fetch_array($consulta)) {
