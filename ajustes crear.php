...
<br>
 ...
 <form  class="text-center" style="font-style: italic; font-weight: bold;" action="ajustes guardar crear.php" method="POST" enctype="multipart/form-data">  
                            <input type="submit" name="submit" value="Crear nuevo usuario." class="btn btn-secondary">   
<br>
            ...
            <div class="col-2 mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                ...
                <div>
                    ...
                    <div class="text-left border rounded" >
                            ...
                            <input type="text" name="apellido1" id="apellido1" placeholder="1º apellido"required>  
                    </div>
                    <br>
                    <div class="text-left border rounded" >
                            <label for="Nombre"  >2º APELLIDO:</label>
                            <input type="text" name="apellido2" id="apellido2" placeholder="2º apellido"required>  
                    </div>
                    <br>
                    <div class="text-left border rounded" >
                            <label for="Nombre"  >UET:</label>
                            <input type="text" name="uet" id="uet" placeholder="uet"required>  
                    </div>
                    <br>
            ...
            <div class="col-2 mt-1 mb-1 ml-1 mr-1 pt-1 pb-1 pl-1 pr-1 text-dark border rounded" style="background-color:#E0F4F2;">
                ...
                <div>
                    ...
                    <div class="text-left border rounded" >
                            ...
                            <input type="text" name="ju" id="ju" placeholder="JU" required>  
                    </div>
                    <br>
                    <div class="text-left border rounded" >
                    ...
                    <div class="text-left border rounded" >
                            ...
                            <select required class="mdb-select md-form" style="'.$background.'width: 90%; height=100%;" type="text" name="tipo" id="tipo"  value="">';?>
                            <?php 
                            $default = "";
                            $states = array(
                                        ""=>"",
