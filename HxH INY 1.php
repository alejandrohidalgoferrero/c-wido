...
<body style="background-color: #D8F5CA" class="text-muted">
    ...
    // $fecha=date("Y-m-d");
    $fecha=date("Y-m-d", strtotime("2021-05-28"));

    $iny="1";
    $inyectora="Inyectora 1";
    $tabla="hxh_inyectora_registro_1";
    $tabla_problemas="hxh_inyectora_problemas_1";
